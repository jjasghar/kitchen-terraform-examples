variable "gcp_project_name" {
  default = "jjasghar" # go here https://console.cloud.google.com/home/dashboard Under Project Info
}
variable "gcp_project_id" {
  default = "jjasghar-183117" # Under Project Info
}
variable "gcp_project_number" {
  default = "441726636010" # Under Project Info
}
